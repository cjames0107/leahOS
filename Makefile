...
USER_PROGRAMS := init hello sh echo cat ls pwd mkdir rm touch cp mv clear \
                 ifconfig ping arp nslookup tests id chmod chown su fetch whoami login useradd passwd stat paint clock gui wserver term uitest browse edit calc settings imgview taskman
