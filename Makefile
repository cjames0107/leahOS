...
BIN_PROGRAMS := init hello sh echo cat ls pwd mkdir rm touch cp mv clear \
                 ...
                 login useradd passwd stat gui wserver desktop tone ipctest e1000d nictest netd nettest ping6 fetch6 blockd blktest audiod authd usbd lspci vfsd vfstest
